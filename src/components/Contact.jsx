        ...
        <div className="mt-14 grid items-start gap-10 lg:grid-cols-2">
          ...
          <Reveal className="space-y-5">
            <p className="text-base leading-relaxed text-muted">
              The fastest way to reach me is by email — I usually respond within a
              couple of days.
            </p>
            ...
            <div className="surface-card flex items-center justify-between gap-3 p-5 transition-colors hover:border-accent-500">
              ...
              >
                <span className="flex min-w-0 items-center gap-3">
                  ...
                  <span className="min-w-0 flex-1">
                    <span className="block text-sm font-semibold text-content">Email</span>
                    <span className="block truncate text-sm text-muted">{personal.email}</span>
                  </span>
                </span>
              </a>
              <span className="flex shrink-0 items-center gap-2">
                ...
                <ArrowUpRight className="h-5 w-5 text-accent-400" aria-hidden="true" />
              </span>
            ...
            >
              <span className="flex min-w-0 items-center gap-3">
                ...
                <span className="min-w-0 flex-1">
                  <span className="block text-sm font-semibold text-content">GitHub</span>
                  <span className="block truncate text-sm text-muted">Code & projects</span>
                </span>
              </span>
              <ArrowUpRight className="h-5 w-5 text-accent-400" aria-hidden="true" />
            </a>
            ...
            >
              <span className="flex min-w-0 items-center gap-3">
                ...
                <span className="min-w-0 flex-1">
                  <span className="block text-sm font-semibold text-content">LinkedIn</span>
                  <span className="block truncate text-sm text-muted">Professional profile</span>
                </span>
              </span>
              <ArrowUpRight className="h-5 w-5 text-accent-400" aria-hidden="true" />
            </a>
            ...
            >
              ...
              {sent ? (
                ...
                <p className="text-xs leading-snug text-faint">
                  This form opens a pre-filled email in your mail app —
